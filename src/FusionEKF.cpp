...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
    ...
    cout << "RADAR MEASURMENT" <<endl;
    if (ekf_.x_[3] < -20){
      cout << "Samll x[3]: " << ekf_.x_[3] << endl;
      cout << "raw_measurements_: " << measurement_pack.raw_measurements_(0) << " " << measurement_pack.raw_measurements_(1) << endl;
    }
  } else {
    // Laser updates
    ekf_.H_ = H_laser_;
